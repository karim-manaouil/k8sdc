/*
	This probes reads the Kubernetes state objects and calculates
	phase transition percentiles. It is developped for the UCC20
	paper to measure Kubernetes pod startup latency in the context
	of studying Kubernetes in a Geo-Distributed context.
	
	Author: Karim MANAOUIL, Stack team, Inria, France.
*/
